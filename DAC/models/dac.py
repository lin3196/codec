...
from modules.layers import Snake1d, WNConv1d, WNConvTranspose1d
...
class DAC(nn.Module):
    ...
    def forward(
        ...
        rvq_outputs = self.encode(
            audio_data, n_quantizers
        )

        x = self.decode(rvq_outputs["z"])
        
        outputs = {"audio": x[..., :length]}
...
if __name__ == "__main__":
    ...
    model = DAC(sample_rate=16000).to(device)
